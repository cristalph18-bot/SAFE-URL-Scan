...
# ============================================================
# CARGA DEL MODELO SAFE FINAL
# ============================================================

RUTA_MODELO = (
    "/content/drive/MyDrive/SAFE/"
    "modelo_safe_v4_final_11.pkl"
)

RUTA_VARIABLES = (
    "/content/drive/MyDrive/SAFE/"
    "variables_safe_v4_final_11.pkl"
)
...
def extraer_caracteristicas_safe_v3(url):
    ...
    # Agregar esquema para permitir el análisis
    ...
    # --------------------------------------------------------
    # PROPORCIÓN DE DÍGITOS EN HOSTNAME
    # --------------------------------------------------------
...
# ============================================================
# FUNCIÓN DE CÁLCULO DEL RISK SCORE
# ============================================================
...
def calcular_risk_score(url):
    ...
    # Orden exacto de variables utilizado por el modelo
    ...
    # En SAFE la clase 0 corresponde a phishing
...
st.markdown(
    '<div class="safe-title">🛡️ SAFE URL Scan</div>',
    unsafe_allow_html=True
)
        ...
        try:
            ...
            if risk_score < 30:
                ...
                st.write(
                    ...
                    "contexto antes de compartir información "
                    "sensible."
                )
                ...
                st.write(
                    "Realiza verificaciones adicionales antes "
                    "de ingresar credenciales, efectuar pagos "
                    "o continuar con acciones sensibles."
                )
